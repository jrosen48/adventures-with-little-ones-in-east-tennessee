...
<img title="a title" alt="Alt text" src="img/abrams-road.jpeg" width = "300">

<img title="a title" alt="Alt text" src="img/joro-josh-abrams-fishy-poo.jpeg" width = "300">


<img title="a title" alt="Alt text" src="img/abrams-log.jpeg" width = "300">
<img title="a title" alt="Alt text" src="img/abrams-high.jpeg" width = "300">
<img title="a title" alt="Alt text" src="img/abrams-high-water-crossing.jpeg" width = "300">
<img title="a title" alt="Alt text" src="img/abrams-family.jpeg" width = "300">
<img title="a title" alt="Alt text" src="img/abrams-campground.jpeg" width = "300">
<img title="a title" alt="Alt text" src="img/abrams-campground-walking.jpeg" width = "300">
<img title="a title" alt="Alt text" src="img/abrams-vista.jpeg" width = "300">
...
<img title="a title" alt="Alt text" src="img/josh-backpacking-abrams.jpeg" width = "300">
