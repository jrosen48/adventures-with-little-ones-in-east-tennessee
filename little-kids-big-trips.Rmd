...
<!--chapter:end:02-00-getting-started.Rmd-->
...
<!--chapter:end:02-01-climate-weather.Rmd-->
...
<!--chapter:end:02-02-getting-started.Rmd-->

# Gear


<!--chapter:end:02-03-gear.Rmd-->

# Planning Your First Hike

Your first hike

<!--chapter:end:02-04-planning.Rmd-->

# Science Primer

<!--chapter:end:02-05-science-primer.Rmd-->

# History Primer

<!--chapter:end:02-06-history-primer.Rmd-->
...
<!--chapter:end:02-07-regions-overview.Rmd-->

# (PART) The Tennessee Valley {-}

<!--chapter:end:03-00-tennessee-valley.Rmd-->
...
```{r, fig.cap="Seven Islands Meadow"}
...
```{r, fig.cap="Views of Mt. LeConte from the Ridge of the Meadow"}
knitr::include_graphics(here("img", "seven-islands-view-of-leconte.jpeg"))
```

There are bathrooms on the left just past the barn. If you walk past the bathrooms, there is a signpost pointing to the *Hickory Ridge* trail. This is a densely wooded, steep, relatively short (0.8 miles) loop trail that takes you back to the trailhead. We think we have never been on this trail and *not* seen deer! It also offers a nice view of the river.

```{r, fig.cap="The Trail Toward Hickory Ridge"}
knitr::include_graphics(here("img", "seven-islands-hickory.jpg"))
```

Walking past the two side trails we mentioned and the bathrooms, continue along the paved path, noticing that the grad of the path starts to decline slightly. You will have walked a total of **.40** miles when the trail begins to flatten---and turn to the right. At this bend in the path, note the bench to catch a quick rest. This is a great spot right at the edge of the forest to view birds. 

```{block, type='scibox', echo = TRUE}
...
```{r, fig.cap="The French Broad River"}
...
<!--chapter:end:03-01-seven-islands.Rmd-->

# Ijams Quarry Overlook
...
dd <- d %>% filter(str_detect(`Hike Name`, "Ijams"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "ijams-crag-map.png"))
```
...
<!--chapter:end:03-02-ijams-urban-wilderness.Rmd-->
...
dd <- d %>% filter(str_detect(`Hike Name`, "William Hastie"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "william-hastie-map.png"))
```
...
<!--chapter:end:03-04-knox-blount.Rmd-->
...
<!--chapter:end:03-05-lakeshore.Rmd-->
...
dd <- d %>% filter(str_detect(`Hike Name`, "House"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "house-mountain-overlook-map.png"))
```
...
<!--chapter:end:03-06-house-mountain.Rmd-->

# (PART) The Cumberland Plateau {-}

<!--chapter:end:04-00-cumberland.Rmd-->

# Songbird Loop (Norris Dam)
...
<!--chapter:end:04-02-obed-point.Rmd-->
...
<!--chapter:end:04-03-emory-falls.Rmd-->
...
<!--chapter:end:04-05-twin-arches.Rmd-->
...
dd <- d %>% filter(str_detect(`Hike Name`, "Honey"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "honey-creek-loop-map.png"))
```
...
<!--chapter:end:04-06-big-south-fork-honey-creek.Rmd-->

# Bandy Creek (Big South Fork)
...
dd <- d %>% filter(str_detect(`Hike Name`, "Bandy"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "bandy-creek-fall-branch-falls-map.png"))
```
...
<!--chapter:end:04-07-big-south-fork-bandy.Rmd-->

# (PART) The Smokies {-}

<!--chapter:end:05-00-smokies-and-beyond.Rmd-->
...
dd <- d %>% filter(str_detect(`Hike Name`, "Little River"))
...
```{r, fig.cap="Seven Islands Loop Trail Map", eval = TRUE}
knitr::include_graphics(here("output", "little-river-loop-map.png"))
```
...
<!--chapter:end:05-01-little-river.Rmd-->
...
<!--chapter:end:05-03-middle-prong.Rmd-->
...
dd <- d %>% filter(str_detect(`Hike Name`, "Big Creek"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "big-creek-map.png"))
```
...
<!--chapter:end:05-04-big-creek.Rmd-->
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "abrams-falls-map.png"))
```
...
<!--chapter:end:05-05-abrams-falls.Rmd-->
...
dd <- d %>% filter(str_detect(`Hike Name`, "Cosby"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "cosby-nature-trail-map.png"))
```
...
dd <- d %>% filter(str_detect(`Hike Name`, "Andrews"))
...
```{r, fig.cap="Seven Islands Loop Trail Map"}
knitr::include_graphics(here("output", "andrews-bald-map.png"))
```
...
<!--chapter:end:05-07-andrews.Rmd-->

# (PART) Doing More {-}

<!--chapter:end:06-00-looking-ahead.Rmd-->

# Top Five Lists {#top-lists}


<!--chapter:end:06-000-top-lists.Rmd-->
...
<!--chapter:end:06-01-doing-more.Rmd-->
...
<!--chapter:end:06-02-learning-more.Rmd-->
...
<!--chapter:end:06-03-giving-back.Rmd-->
...
<!--chapter:end:08-acknowledgments.Rmd-->
